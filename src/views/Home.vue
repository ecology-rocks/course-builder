...
function handleCta(mode = 'login') {
  // If the user is already logged in, just go to dashboard
  if (userStore.user) {
    router.push('/dashboard')
    return
  }

  // If the button clicked was specifically for signup, pass the query param
  if (mode === 'signup') {
    router.push({ path: '/dashboard', query: { mode: 'signup' } })
  } else {
    // Default to standard login view
    router.push('/dashboard')
  }
}
</script>
  ...
  <div class="landing-page">
    ...
    <nav class="navbar">
      ...
      <div class="nav-actions">
        <button v-if="!userStore.user" @click="handleCta('login')" class="btn-text">Log In</button>
    ...
    <header class="hero">
      <div class="hero-content">
        ...
        <div class="cta-row">
          <button @click="handleCta('signup')" class="btn-primary big">Start Designing for Free</button>
    ...
    <section class="features">
      <div class="container">
        <h2>Built for the Rules</h2>
        <div class="feature-grid">

          <div class="feature-card">
            <div class="icon">📐</div>
            <h3>Smart Scaling</h3>
            <p>Change ring size instantly or rearrange your course in a flash. Select, move, and rotate entire groups of
              objects without breaking a sweat.</p>
          </div>

          <div class="feature-card">
            <div class="icon">🪺</div>
            <h3>Made For Nesting</h3>
            <p>Design your whole day in one sitting. Compare against any other map and automatically calculate
              statistics within and between maps.</p>
          </div>

          <div class="feature-card">
            <div class="icon">⚖️</div>
            <h3>Perfect Prints</h3>
            <p>Generate fully legal maps with measurements, anchor bales, grid labels, legends, and statistics. No more
              revising fifty times because you forgot something.</p>
          </div>
      ...
      <div class="container">
        ...
        <div class="pricing-cards">
          ...
          <div class="card">
            ...
            <button @click="handleCta('signup')" class="btn-outline">Try Free</button>
          </div>
          ...
          <div class="card highlight">
            ...
            <button @click="handleCta('signup')" class="btn-primary">Get the Deal</button>
            <p style="margin-top: 10px; font-size: 0.9rem; color: #2e7d32;">
              Have a code? Apply at checkout!
            </p>
          </div>

        </div>
        <div class="guarantee">
          <p>Standard pricing will be <strong>$99/year</strong> after launch. <br>Join now to keep the $75 rate for
            life.</p>
        </div>
      </div>
    </section>
